...
android {
    namespace = "com.example.es_position3_new"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.es_position3_new"
        minSdk = 35
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("com.google.android.gms:play-services-location:18.0.0") // Dipendenza per FusedLocationProviderClient
