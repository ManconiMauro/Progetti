...
export default class viewModel {
    static async fetchData(userLocation) {
        try {
          ...
          const menuList = await CommunicationController.getMenusFebbraio(lat, lng);
    ...
    static async retrieveMenu(singleMenu){
        ...
        if(!test){
          ...
          if(singleMenu.discount){
            console.log("Esame Febbraio: menù: "+singleMenu.name+". Sconto applicato: "+singleMenu.discount+".")
            menu = {
              mid: singleMenu.mid,
              ...
              disocunt: singleMenu.discount,
            };
          }else if(singleMenu.missedDiscount){
            console.log("Esame Febbraio: menù: "+singleMenu.name+". Sconto mancato: "+singleMenu.missedDiscount+".")
            menu = {
              mid: singleMenu.mid,
              name: singleMenu.name,
              price: singleMenu.price,
              ...
              shortDescription: singleMenu.shortDescription,
              base64: menuImg.base64, // Evita di usarlo in console.log per lunghezza
              missedDiscount: singleMenu.missedDiscount
            };
          }else{
            console.log("Esame Febbraio: menù: "+singleMenu.name+". Sconto non disponibile.")
            menu = {
              mid: singleMenu.mid,
              name: singleMenu.name,
              price: singleMenu.price,
          ...
          if(singleMenu.discount){
            ...
            menu = {
              ...
              deliveryTime: singleMenu.deliveryTime,
              shortDescription: singleMenu.shortDescription,
              base64: test.base64, // Evita di usarlo in console.log per lunghezza
              disocunt: singleMenu.discount,
            };
          }else if(singleMenu.missedDiscount){
            console.log("Esame Febbraio: menù: "+singleMenu.name+". Sconto mancato: "+singleMenu.missedDiscount+".")
    ...
    static async fetchUser(){
        ...
        try {
            ...
            user = await CommunicationController.getUserFebbraio();
        } catch (error) {
