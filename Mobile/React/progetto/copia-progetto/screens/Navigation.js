...
import AbbonamentoMangione from './AbbonamentoMangione';
import commonStyles from '../style/StyleSheet';

const Stack = createStackNavigator();
const Tab = createBottomTabNavigator();

const Navigation = ({ lastScreen, userLocation, buyMenu, order, handleNavigateToMap, onBackClick }) => {
  ...
  const TabNavigator = () => {
    return (
      ...
      >
        ...
        <Tab.Screen
          name="Profile"
          children={(props) => <ProfileScreen navigation={props.navigation} />}
          options={{
            tabBarLabel: 'Profilo',
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Tabs" screenOptions={{ headerShown: false }}>
        ...
        {props => <AbbonamentoMangione {...props} onBackClick={() => props.navigation.navigate('Tabs', { screen: 'Profile' })} />}
      </Stack.Screen>
      </Stack.Navigator>
    </NavigationContainer>
  );
