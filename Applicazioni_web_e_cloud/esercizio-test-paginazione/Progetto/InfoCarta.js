...
async function Info() {
    ...
    var character
    await getPgFromMarvel('public/characters', id).then(result => {
        character = result.data.results
        })
        .catch(error => console.log(error))
    console.log(character)
    mostraFigurina(character[0])
}

function mostraFigurina(character) {
    console.log(character)
    var id = character.id;
    ...
    clone.getElementsByClassName('card-title')[0].innerHTML = character.name;
    clone.getElementsByClassName('card-text')[0].innerHTML = character.description;
    clone.getElementsByClassName('img-fluid')[0].src = character.thumbnail.path + ".jpg";
    ...
    for (let i = 0; i < character.comics.returned; i++) {
      help1 += character.comics.items[i].name + "</br>";
    }
    for (let i = 0; i < character.series.returned; i++) {
      help2 += character.series.items[i].name + "</br>";
    }
    for (let i = 0; i < character.events.returned; i++) {
      help3 += character.events.items[i].name + "</br>";
    }
  
    clone.getElementsByClassName('comics')[0].innerHTML = "<b>comics:</b> " + help1 + "</br>";
    clone.getElementsByClassName('series')[0].innerHTML = "<b>series:</b> " + help2 + "</br>";
    clone.getElementsByClassName('events')[0].innerHTML = "<b>events:</b> " + help3 + "</br>";
    card.after(clone);
...
function mostraProfilo() {
    ...
    var daNascondere = document.getElementsByClassName('contenitore');
...
function reverse() {
    var daMostrare = document.getElementsByClassName('contenitore');
